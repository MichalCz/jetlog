...
module.exports = class JetLog extends DataStream {
    constructor(...args) {
        super(...args);
    ...
    _handleOptions() {
        const {read_level, fetch_line, name} = Object.assign(this.constructor.defaults, this._options);

        this._jetlog_name = name;
    ...
    async message(level, msg, ...extra) {
        ...
        const obj = new Entry(msg, level, this._jetlog_name, stack, extra);
